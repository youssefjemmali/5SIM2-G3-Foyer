...
public class ReservationService implements IReservationService {
    ...
    public Reservation ajouterReservationEtAssignerAChambreEtAEtudiant(Long numChambre, long cin) {
        ...
        log.info("Current number of reservations for room {}: {}", numChambre, numRes); // Replace print statement with logger
        switch (c.getTypeC()) {
            case SIMPLE:
                if (numRes < 1) {
                    ajout = true;
        ...
        if (ajout) {
            ...
            log.info("Reservation {} added successfully", res.getIdReservation());
        }
        return res;
    }
