...
public class ReservationServiceMockTest {
    ...
    void testAddOrUpdate() {
        ...
        Assertions.assertEquals(foyer, result);
        Mockito.verify(foyerRepository, times(1)).save(foyer);
    }
    ...
    void testFindAll() {
        ...
        Assertions.assertEquals(foyers, result);
        Mockito.verify(foyerRepository, times(1)).findAll();
    }
    ...
    void testAffecterFoyerAUniversite() {
        ...
        Assertions.assertEquals(universite, result);
        Assertions.assertEquals(foyer, universite.getFoyer());
    ...
    void testDesaffecterFoyerAUniversite() {
        ...
        Assertions.assertEquals(universite, result);
        AssertionErrors.assertNull(universite.getFoyer());
        verify(universiteRepository, times(1)).save(universite);
    }
*/
    @Test
